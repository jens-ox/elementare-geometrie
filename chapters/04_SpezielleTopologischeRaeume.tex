...
\begin{definition}[Regulärer Polyeder]
  Ein Polyeder in $ \R^3 $ heißt \term{regulär}\label{def:regulaererPolyeder}, falls alle Seitenflächen kongruente reguläre $ n $-Ecke (d.h. sie haben gleich lange Kanten) sind.
\end{definition}