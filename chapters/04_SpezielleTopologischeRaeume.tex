...
\begin{example}[Produkt-Mannigfaltigkeiten]
  Für $ M^m $ und $ N^n $ $ m $- bzw. $ n $-dimensionale differenzierbare Mannigfaltigkeit ist die Produkt-Mannigfaltigkeit $ M \times N $ eine $ (m+n) $-dimensionale $ C^\infty $-Mannigfaltigkeit.\footnote{\textbf{Übung}!}
\end{example}