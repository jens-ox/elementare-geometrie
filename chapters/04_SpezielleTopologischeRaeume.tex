...
\begin{remark}[Wohldefiniertheit der Differenzierbarkeit]
  ...
  \begin{proof}
    \emph{Erster Test}: $ \psi \circ F \circ \phi^{-1} $, \emph{zweiter Test} $ \tilde{\psi} \circ F \circ \tilde{\phi}^{-1} $ \\
    Es gilt:
    \begin{align*}
      \psi \circ F \circ \phi^{-1} &= \psi \circ \underbrace{\tilde{\psi}^{-1} \circ \tilde{\psi}}_{\text{Id}_{\R^n}} \circ F \circ \underbrace{\tilde{\phi}^{-1} \circ \tilde{\phi}}_{\text{Id}_{\R^n}} \circ \phi^{-1} \\
        &= \underbrace{\left( \psi \circ \tilde{\psi}^{-1} \right)}_{C^\infty} \circ \left( \tilde{\psi} \circ F \circ \tilde{\phi}^{-1} \right) \circ \underbrace{\left( \tilde{\phi} \circ \phi^{-1} \right)}_{\text{Kartenwechsel}}
    \end{align*}
...
\begin{remark}[Geometrische Eigenschaften parametrisierungsunabhängig]
  ...
  \begin{equation*}
    H \coloneqq F_1 \circ F_2 : \R^2 \supset F_2^{-1}(W) \to F_1^{-1}(W) \subset \R^2
  \end{equation*}
  ...
  \begin{proof}
    ...
    \begin{align*}
      \tilde{F_1} : U \times \R &\to \R^3 \\
        \tilde{F_1}(u,v,t) &\coloneqq \left( x(u,v),y(u,v),z(u,v)+\bm{t} \right)\text{.}
    \end{align*}
    $ \tilde{F_1} $ ist differenzierbar und $ \tilde{F_1}|_{U \times \{ 0 \}} = F_1 $.
  \end{proof}
\end{remark}