...
\begin{figure}[H]
  \includegraphics[width=0.6\textwidth]{p52-i1}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{p53-i1}
...
\begin{figure}[H]
  \includegraphics[width=.8\textwidth]{p54-i1}
...
\begin{remark}[Wozu ist die erste Fundamentalform gut?]
 ...
 \begin{enumerate}
  ...
  \begin{figure}[H]
    \includegraphics[width=.8\textwidth]{p58-i1}
  ...
  \begin{figure}[H]
    \includegraphics[width=.4\textwidth]{p59-i1}
...
\begin{figure}[H]
  \includegraphics[width=.5\textwidth]{p61-i1}
...
\begin{example}[Normalenvektoren]
  ...
  \begin{enumerate}
    ...
    \begin{minipage}{.375\textwidth}
      \begin{figure}[H]
        \includegraphics[width=.9\textwidth]{p63-i1}
...
\begin{figure}[H]
  \includegraphics[width=0.4\textwidth]{p63-i3}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{p64-i1}
\end{figure}
...
\begin{theorem}[Satz von Bertrand-Puiseux, 1848]
  ...
  \begin{minipage}{.35\textwidth}
    \begin{figure}[H]
      \includegraphics[width=.8\textwidth]{p65-i1}
    \end{figure}
  \end{minipage}
\end{theorem}
...
\begin{definition}[Geodätische Krümmung]
  ...
  \begin{figure}[H]
    \includegraphics[width=.6\textwidth]{p66-i1}
...
\begin{lemma}
  ...
  \begin{minipage}{.375\textwidth}
    \begin{figure}[H]
      \includegraphics[width=\textwidth]{p68-i1}
    \end{figure}
  \end{minipage}
  \begin{proof}
    \ 
...
\begin{theorem}[Satz von Gauß-Bonnet --- lokale Version]
  ...
  \begin{minipage}{.375\textwidth}
    \begin{figure}[H]
      \includegraphics[width=\textwidth]{p67-i1}
    \end{figure}
  \end{minipage}
  \begin{proof}
    ...
    \begin{minipage}{.375\textwidth}
      \begin{figure}[H]
        \includegraphics[width=.6\textwidth]{p69-i1}
      \end{figure}
      \vspace*{0.5em}
    \end{minipage}
...
\begin{figure}[H]
  \includegraphics[width=.8\textwidth]{p72-i1}
\end{figure}
...
\begin{minipage}{.3\textwidth}
  \begin{figure}[H]
    \includegraphics[width=.8\textwidth]{p72-i3}
  \end{figure}
\end{minipage}
...
\begin{remark}[Spezialfälle des Spezialfalls]
  ...
  \begin{enumerate}
    ...
    \begin{minipage}{.3\textwidth}
      \begin{figure}[H]
        \includegraphics[width=\textwidth]{p72-i4}
      \end{figure}
    \end{minipage}
...
\begin{figure}[H]
  \includegraphics[width=.8\textwidth]{p73-i1}
...
\begin{definition}[Triangulierung --- Approximation durch Simplizialkomplexe]
  ...
  \begin{enumerate}
    ...
    \begin{minipage}{.525\textwidth}
      \begin{figure}[H]
        \includegraphics[width=.8\textwidth]{p74-i1}
      \end{figure}
    \end{minipage}
  \end{enumerate}
  \ \\
...
\begin{minipage}{.45\textwidth}
  \begin{figure}[H]
    \includegraphics[width=.8\textwidth]{p75-i1}
    \vspace*{1em}
...
\begin{minipage}{.475\textwidth}
  \begin{figure}[H]
    \includegraphics[width=\textwidth]{p75-i2}
