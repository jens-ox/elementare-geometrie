...
\begin{problem*}[4]
  \begin{enumerate}
    ...
    Angenommen, es gibt eine Isometrie \( \phi^1: (\R^n, d_\infty) \) nach \( (\R^n, d_1) \). Die Abbildung \( \phi^2 : (\R^n, d_1) \to (\R^n, d_1) \), \( x \mapsto x - \phi^1(0) \) ist eine Translation, also eine Isometrie. \\
...
\begin{problem*}[2a]
  ...
  \end{align*}
  \emph{Anmerkung:} Hier bin ich mir mit den Variablen von \( \phi, \psi \) nicht ganz sicher. Für Verbesserungen gerne melden. % TODO
\end{problem*}
...
\begin{problem*}[2b]
  ...
  % TODO: Schaubild für Sphäre mit K = 1
