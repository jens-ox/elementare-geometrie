...
\begin{example}[Euklidische Metrik auf \( \R^2 \) als Standardmetrik]
  ...
  \end{align*}
  \begin{figure}[H]
    \includegraphics[width=.5\textwidth]{StueckDbKurve}
...
\begin{lemma}[Unabhängigkeit von \( \text{L}_\text{euk} \)]\label{lm:leuklinvarianz} \
  \begin{enumerate}
...
\begin{lemma}[Geraden sind am kürzesten]\label{lemma:geradenkurz}
  ...
  \begin{proof}
    ...
    \begin{minipage}{.45\textwidth}
      \begin{figure}[H]
        \includegraphics[width=.8\textwidth]{RotationKurve}
...
\begin{theorem}[``Neuer'' \ metrischer \( \R^2 \)]
  ...
  \begin{proof}
    ...
    \begin{itemize}
      ...
      \begin{minipage}{.45\textwidth}
        \begin{figure}[H]
          \includegraphics[width=.8\textwidth]{VerschiedeneWege}
      ...
      \begin{minipage}{.45\textwidth}
        \begin{figure}[H]
          \includegraphics[width=.5\textwidth]{Schleifen}
          \caption{``Schleifen''}
        \end{figure}
      \end{minipage}
    \end{itemize}
...
\begin{example}[2-dimensionale sphärische Geometrie als Längenraum]
  ...
  \begin{minipage}{.25\textwidth}
    \begin{figure}[H]
      \includegraphics[width=\textwidth]{KurvenInKugel}
      \caption{Es werden nur Kurven betrachtet, die \underline{in} \( S_R^2 \) liegen}
    \end{figure}
  \end{minipage}
\end{example}

\begin{lemma}[Kurvenlängen rotationsinvariant]\label{lemma:kurvenlaengen}
...
\begin{lemma}[Großkreise sind am kürzesten]
  ...
  \begin{minipage}{.45\textwidth}
    \begin{figure}[H]
      \includegraphics[width=\textwidth]{GrossKleinkreis}
  ...
  \begin{proof}
    ...
    \begin{minipage}{.45\textwidth}
      \begin{figure}[H]
        \includegraphics[width=\textwidth]{GeographischeKoordinaten}
