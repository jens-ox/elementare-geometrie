...
\begin{bla}{Exkurs 1 --- Kurven}
  ...
  Zwei Knoten $ K_1 $, $ K_2 \subset \R^3 $ sind \emph{äquivalent}, falls es einen Homöomorphismus $ h $ von $ \R^3 $ gibt mit $ h(K_1) = K_2 $.\sidenote{\textbf{Knotentheorie} studiert die Äquivalenz von Knoten}
\end{bla}